...
function App() {
  ...
  const [activeTab, setActiveTab] = useState('gallery'); // 'gallery' or 'trash'
          ...
          {!isLoggedIn ? (
            <div className="animate-fade">
              <div className="login-header">
                <h2>Sign In</h2>
                <p>Enter your account credentials to access the vault</p>
              </div>
            ...
            <div className="vault-container">
              <div className="vault-header">
                ...
                <p className="vault-user-email">User: {username}</p>
              </div>
